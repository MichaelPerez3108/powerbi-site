...
<body>
    ...
    <nav class="flex justify-between px-20 py-3 items-center bg-redcs">
        ...
        <button x-on:click="open = ! open" id="apertura">
        <i class="fa-sharp fa-solid fa-xmark fa-2xl cierre" style="color: #fff69b; " id="cierre"></i>
        <i class="fa-sharp fa-solid fa-bars fa-2xl" style="color: #fff69b;" id="icono"></i>
        </button>
        ...
        <div class="flex items-center max-w-3xl min-w-40">
            ...
            <input class="ml-2 rounded-full text-center  outline-none bg-transparent font-" style="width: 600px;" type="text" name="search" id="search" placeholder="Search..." />
        </div>
    ...
    <!-- Menu lateral desplegable-->
        ...
        <div x-show="open" class="relative flex flex-col bg-clip-border  bg-redcs text-gray-700 h-[calc(100vh-4.1rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">
            ...
            <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
                <div role="button" tabindex="0" class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-gray-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                    <div class="flex place-items-center mr-4">
                        <svg class="h-3 w-3 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
