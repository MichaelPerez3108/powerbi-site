...
// The following was modificated by Cusezar SA, for internal purpouses
// ----------------------------------------------------------------------------

import * as auth from "./authentication.js";
import * as PowerBiReportDetails from "./models/embedReportConfig.js";
import * as EmbedConfig from "./models/embedConfig.js";
...
async function getRequestHeader(config) {
    console.log('getRequestHeader', config)
